...
export default function LoginScreen({ navigation }: any) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      Alert.alert('AUTH FAILED', e.message || 'Invalid credentials.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.logoBlock}>
          ...
          <Text style={styles.logoSub}>NEURAL ATTENTION SYSTEM v2.0</Text>
        </View>

        {/* Form */}
        <View style={styles.formBlock}>
          <Text style={styles.formLabel}>// AUTHENTICATE</Text>
          ...
          <TouchableOpacity style={styles.primaryBtn} onPress={handleLogin} disabled={loading}>
            <Text style={styles.primaryBtnText}>{loading ? 'AUTHENTICATING...' : '[ ENTER SYSTEM ]'}</Text>
          </TouchableOpacity>
